...
export default function RegisterPage() {
  ...
  const inputClass =
    'w-full px-4 py-3 bg-db-sidebar border border-db-border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-db-purple focus:border-transparent';
    ...
    <div className="min-h-screen bg-db-dark flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-db-panel rounded-xl p-8 border border-db-border shadow-2xl space-y-5">
          ...
          <div>
            <label htmlFor="confirm" className="block text-sm font-medium text-db-text mb-1">Confirm Password</label>
            <input
              id="confirm"
              type="password"
              required
          ...
          <p className="text-center text-sm text-db-text mt-4">
            ...
            <Link to="/login" className="text-db-purple hover:opacity-80 transition">Sign in</Link>
          </p>
        </form>
      </div>
    </div>
